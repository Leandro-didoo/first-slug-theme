    ...
    return (
        <div>
            ...
            <div className={style.content}>
                <button onClick={()=> router.back()} className={style.goBack}>
                    <div className={style.i}>
                        {/* <CaretLeft color="#333" width={10} /> */}
                        {'<'}
                    </div>
                ...
                {/* outhers post */}
                <section className={style.cardPosts}>
                        ...
                        return (
                            <div className={style.card} key={content.id}>
                                ...
                                <div className={style.carInfo}>
                                    <a href={`/blog/${content.slug}`}><h3>{content.title}</h3></a>
